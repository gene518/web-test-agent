const EXPLICIT_NEW_THREAD_KEY = "web-poartl:explicit-new-thread";
const ACTIVE_THREAD_RUN_PREFIX = "web-poartl:active-thread-run:";
const LATEST_ACTIVE_RUN_KEY = "web-poartl:latest-active-run";
const JOINED_THREAD_RUN_PREFIX = "web-poartl:joined-thread-run:";
...
export function getLatestActiveRun(): { threadId: string; runId: string } | null {
  ...
  try {
    ...
    if (typeof parsed.threadId === "string" && typeof parsed.runId === "string") {
      return {
