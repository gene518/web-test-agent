...
/**
 * 无头组件：获取 artifact 的标题与内容，并通过 React Portal 渲染到
 * `ArtifactContent` 和 `ArtifactTitle` 对应位置。
 */
...
/**
 * 用于判断是否有任意 artifact 处于打开状态的通用 hook。
 */
...
/**
 * artifact 可以按需提供额外上下文，这些上下文会在创建新 run 时使用。
 */
